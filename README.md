...
**Population :** 15 participants volontaires en bonne santé (20–35 ans).  
**Design :** étude expérimentale intra-sujets, 2 conditions — reposée vs privation partielle de sommeil (16–20 h d'éveil).
...
- **N = 15** volontaires sains (cible : ~10 hommes / 5 femmes)
- Âge : 20–35 ans
- Deux sessions par participant :
  - **Session reposée** — après une nuit de sommeil normale
  - **Session fatigue** — après 16–20 h d'éveil prolongé continu

### Déroulement d'une session

| Phase | Durée approx. | Description |
|---|---|---|
| 1 — Préparation | 15–25 min | Accueil, consentement, pose des électrodes EEG/ECG/EMG, calibration Kinect |
| 2 — KSS initial | ~2 min | Auto-évaluation subjective de la somnolence |
